...
public class Main {
        ...
        if (!orphans.contains(b)) {
          ...
          if(b.children!=null){
            for (Block c : b.children) {
              pw.println("child:  "+c+"====="+c.getMinter()+"====="+c.getHeight()+"-------"+c.getParent().now_weight);
            }
   ...
   */
  public static void constructNetworkWithAllNodes(int numNodes) throws CloneNotSupportedException {
