...
public class ProofOfWorkBlock extends Block {
   ...
   */
  public ProofOfWorkBlock(ProofOfWorkBlock parent, Node minter, long time, BigInteger difficulty) throws CloneNotSupportedException {
   ...
   */
  public static ProofOfWorkBlock genesisBlock(Node minter) throws CloneNotSupportedException {
