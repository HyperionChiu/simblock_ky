...
public class Ghost extends AbstractConsensusAlgo {
    ...
    public boolean isReceivedBlockValid(Block receivedBlock, Block currentBlock) {
        ...
        ProofOfWorkBlock receivedBlockParent = receivedBlockHeight == 0 ? null :
                (ProofOfWorkBlock) receivedBlock.getBlockByGhost();
    ...
    @Override
    public ProofOfWorkBlock genesisBlock() throws CloneNotSupportedException {
